defmodule InstituteWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: InstituteWeb

      import Plug.Conn
      import InstituteWeb.Gettext
      import InstituteWeb.AuthPlug, only: [authenticate_user: 2]
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/institute_web/templates",
